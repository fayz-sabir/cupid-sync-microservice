...
import com.nuitee.adapterpersistence.repository.HotelI18nJpaRepository;
...
public class HotelI18nRepositoryAdapter implements HotelI18nRepositoryPort {
    ...
    public void upsertHotelI18n(HotelI18n hotelI18n, long hotelPkId) {
        ...
        if (optionalHotelEntity.isEmpty()) {
            ...
            hotelRepo.save(toEntity.hotelI18n(hotelI18n, hotelPkId));
        ...
        hotelRepo.save(toEntity.updateHotelI18nEntity(managed, hotelI18n));
    }
}
